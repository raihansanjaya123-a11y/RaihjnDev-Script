...
local function CreateGridSelectorUI()
    local success, err = pcall(function()
        ...
        -- ========== TOMBOL MANUAL (SESUAI PERMINTAAN) ==========
        ...
        -- Tombol "Semua"
        local btnAll = Instance.new("TextButton", btnRow)
        btnAll.Text = "✔ Semua"
        btnAll.Size = UDim2.new(1/3, -3, 1, 0)
        btnAll.Position = UDim2.new(0, 0, 0, 0)
        btnAll.BackgroundColor3 = C_ACC
        btnAll.TextColor3 = C_TXT
        ...
        btnAll.MouseButton1Click:Connect(function()
            ...
            -- Refresh tampilan (sembunyikan lalu munculkan lagi)
            mainFrame.Visible = false
            task.wait()
            mainFrame.Visible = true
        end)
        btnAll.MouseEnter:Connect(function()
            btnAll.BackgroundColor3 = btnAll.BackgroundColor3:Lerp(Color3.new(1,1,1),0.14)
        end)
        ...
        -- Tombol "Hapus"
        local btnClr = Instance.new("TextButton", btnRow)
        btnClr.Text = "✖ Hapus"
        btnClr.Size = UDim2.new(1/3, -3, 1, 0)
        btnClr.Position = UDim2.new(1/3, 2, 0, 0)
        btnClr.BackgroundColor3 = Color3.fromRGB(175,48,48)
        btnClr.TextColor3 = C_TXT
        btnClr.Font = Enum.Font.GothamSemibold
        btnClr.TextSize = 12
        btnClr.BorderSizePixel = 0
        btnClr.AutoButtonColor = false
        Instance.new("UICorner", btnClr).CornerRadius = UDim.new(0, 6)
        ...
        btnClr.MouseEnter:Connect(function()
            btnClr.BackgroundColor3 = btnClr.BackgroundColor3:Lerp(Color3.new(1,1,1),0.14)
        end)
        btnClr.MouseLeave:Connect(function()
            btnClr.BackgroundColor3 = Color3.fromRGB(175,48,48)
        end)

        -- Tombol "Atas"
        local btnAtas = Instance.new("TextButton", btnRow)
        btnAtas.Text = "⬆ Atas"
        btnAtas.Size = UDim2.new(1/3, -3, 1, 0)
        btnAtas.Position = UDim2.new(2/3, 2, 0, 0)
        btnAtas.BackgroundColor3 = Color3.fromRGB(95,68,185)
        btnAtas.TextColor3 = C_TXT
        btnAtas.Font = Enum.Font.GothamSemibold
        btnAtas.TextSize = 12
        btnAtas.BorderSizePixel = 0
        btnAtas.AutoButtonColor = false
        Instance.new("UICorner", btnAtas).CornerRadius = UDim.new(0, 6)
        ...
        btnAtas.MouseEnter:Connect(function()
            btnAtas.BackgroundColor3 = btnAtas.BackgroundColor3:Lerp(Color3.new(1,1,1),0.14)
        end)
        btnAtas.MouseLeave:Connect(function()
            btnAtas.BackgroundColor3 = Color3.fromRGB(95,68,185)
        end)
